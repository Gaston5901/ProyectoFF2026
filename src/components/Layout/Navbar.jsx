...
const Navbar = () => {
  ...
  if (user && isAdmin()) {
    const isReportesPage = location.pathname.startsWith('/admin/reportes');
    // Sidebar: desktop expandido, tablet colapsado, móvil hamburguesa
    const sidebarWidth = isReportesPage ? 0 : (sidebarHover || isTablet ? 240 : 64);
    ...
    return (
      <>
        <nav className="navbar">
          <div className="navbar-container">
            ...
            <div className="navbar-admin-right">
              ...
              {!isReportesPage && (isMobile || isTablet) && (
                <button
        ...
        {!isReportesPage && !isMobile && (
          ...
          >
            <div className="sidebar-header">
              <span style={{fontWeight: 'bold', fontSize: '1.2rem'}}>{roleLabel}</span>
            </div>
        ...
        {!isReportesPage && isMobile && showMobileSidebar && (
          <div
